...
(function () {
  ...
  const ZH = {
    ...
    'topbar.forkHereTooltip':       '在此分支 (Alt+B 選擇 K 棒)',
    'topbar.branches':              '分支',
    'topbar.branchesTooltip':       '分支管理',
    'topbar.openDataFolder':        '開啟資料夾',
    'topbar.openDataFolderTooltip': '在檔案總管中開啟 market_data 資料夾',
    'topbar.openedDataFolder':      '已開啟 market_data 資料夾（可能在視窗後面）',
    'topbar.reloadData':            '重新載入',
    'topbar.reloadDataTooltip':     '重新載入資料 (新增 / 修改檔案後)',
    'topbar.gotoLatest':            '回到最新',
    'topbar.gotoLatestTooltip':     '回到最新K棒 (結束歷史瀏覽)',
    'topbar.indicators':            '技術指標',
    'topbar.indicatorsTooltip':     '新增 / 管理技術指標',
    'topbar.eventLog':              '事件日誌',
    'topbar.eventLogTooltip':       '結構事件日誌 — replay 時看 BOS/CHoCh/Zone 變化',
    'topbar.multiPane':             '多頻率',
    'topbar.multiPaneTooltip':      '多頻率視圖 — 同時顯示多個時間週期',
    'panes.layoutLabel':            '版面：',
    'panes.layoutCols3':            '三等分',
    'panes.layoutMainstack':        '主圖＋側欄',
    'panes.layoutQuad':             '2×2 四宮格',
    'panes.addPane':                '+ 新增面板',
    'panes.removePaneTooltip':      '移除面板',
    'panes.emptySlot':              '+ 加入頻率面板',
    'panes.currentTfTooltip':       '輸入頻率',
    'panes.manageTfTooltip':        '管理常用頻率',
    'panes.manageTfTitle':          '常用頻率',
    'panes.tfGroupMinutes':         '分鐘',
    'panes.tfGroupHours':           '小時',
    'panes.tfGroupDaysUp':          '日以上',
    'eventLog.title':               '結構事件日誌',
    'eventLog.empty':               '（尚無事件 — 進入 replay 模式步進看 BOS/CHoCh/Zone 變化）',
    'eventLog.clearTooltip':        '清空日誌',
    'eventLog.filterBos':           'BOS',
    'eventLog.filterChoch':         'CHoCh',
    'eventLog.filterZone':          'Zone',
    'topbar.newTab':                '新分頁',
    'topbar.tabClose':              '關閉',

    // panel.indicators.* — indicator-manager-spec strings (zh)
    'panel.indicators.libraryTitle':     '技術指標',
    'panel.indicators.searchPlaceholder':'搜尋指標…',
    'panel.indicators.settingsTitle':    '指標設定',
    'panel.indicators.legendShow':       '顯示',
    'panel.indicators.legendHide':       '隱藏',
    'panel.indicators.legendSettings':   '設定',
    'panel.indicators.legendRemove':     '移除指標',
    'panel.indicators.legendCollapse':   '收合指標列表',
    'panel.indicators.legendExpand':     '展開指標列表',
    'panel.indicators.empty':            '尚未註冊任何指標',
    'panel.indicators.noMatch':          '沒有符合的指標',
    ...
    'tool.rectangle':               '矩形',
    'tool.rectangleTooltip':        '矩形 (Alt+R 或 Alt+G)',
    'tool.path':                    '路徑',
    ...
    'tool.fiboTime':                '斐波那契時間',
    'tool.fiboTimeTooltip':         '斐波那契時間（趨勢時間投影）(Alt+I)',
    'tool.positionSettings':        '部位工具設定',
    'tool.clearAll':                '清除全部',
    'tool.addText':                 '+ 新增文字',
    'tool.addTextEditing':          '新增文字',
    'tool.text':                    '文字',
    'tool.textTooltip':             '文字 (Alt+X)',
    ...
    'replay.randomBar':             '隨機K線',
    'replay.menuItemLatest':        '最新K棒',
    'replay.randomBarTooltip':      '隨機起點（跳到隨機一根K線）',
    'replay.statusRandom':          '已跳到隨機起點',
    'replay.startMenuTitle':        '選擇起點',
    'replay.menuItemBar':           'K線',
    'replay.menuItemDate':          '日期…',
    'replay.menuItemEarliest':      '最早可用日期',
    'replay.pickRandom':            '選擇隨機K線',
    'replay.pickDate':              '選擇日期',
    'replay.pickEarliest':          '最早可用日期',
    'replay.datePickTitle':         '選擇日期',
    'replay.dateFirstAvail':        '選擇第一個可用日期',
    'replay.dateCancel':            '取消',
    'replay.dateConfirm':           '選擇',
    ...
    'sim.exitAddTp':                '＋ 停利',
    'sim.exitAddSl':                '＋ 停損',
    'sim.exitCoverage':             '停利覆蓋 {pct}%',
    'sim.exitRunner':               '· 剩 {qty} 續抱',
    'sim.exitOver':                 '· 超額 {qty}（已夾至部位）',
    'sim.exitRemove':               '移除此層',
    'sim.exitEmpty':                '尚無出場層級 — 拖曳 +停利/+停損 或按下方新增',
    'sim.beAdjLabel':               '保本',
    'sim.qtyStepTitle':             '每次增減的單位（會記住）',
    ...
    'panel.drawing.textWrap':       '自動換行',
    'panel.drawing.opacity':        '不透明度',
    'panel.drawing.crosshair':      '十字線',
    'panel.drawing.thickness':      '厚度',
    'panel.drawing.lineStyle':      '線條樣式',
    'panel.drawing.arrow':          '箭頭',
    'panel.drawing.arrowLeft':      '左端箭頭',
    'panel.drawing.arrowRight':     '右端箭頭',
    'panel.drawing.extend':         '延伸',
    'panel.drawing.extendLeft':     '延伸左邊線條',
    'panel.drawing.extendRight':    '延伸右邊線條',
    ...
    'panel.drawing.tplBtn':         '範本 ▾',
    'panel.drawing.tplSaveAs':      '另存為...',
    'panel.drawing.tplNamePh':      '範本名稱',
    'panel.drawing.opacity':        '不透明度',
    ...
    'panel.position.toolShowTradeLink': '顯示進出場連接線',
    'panel.position.toolLinkWinColor': '獲利線條色彩',
    'panel.position.toolLinkLossColor': '虧損線條色彩',
    ...
    'history.splitExits':           '分{n}批出場',
    'history.exitDetailTitle':      '分批出場明細',
    ...
    'dlg.rrPopupTitleTarget':       '依停損設定目標',
    'dlg.rrPopupTitleStop':         '依目標設定停損',
    'dlg.rrHint':                   '風報比（大於 0）',
    'dlg.rrTargetLabel':            '目標',
    'dlg.rrStopLabel':              '停損',
    'dlg.tfMonth':                  '月',
    'dlg.tfHour':                   '小時',
    'dlg.tfDay':                    '日',
    ...
    'ctx.setTargetRR':              '依停損設定目標…',
    'ctx.setStopRR':                '依目標設定停損…',
    'ctx.settings':                 '設定…',
    'ctx.objectTree':               '物件樹',
    'ctx.tplMenu':                  '圖表模板',
    'ctx.tplSaveAs':                '另存為…',
  ...
  const EN = {
    ...
    'topbar.forkHereTooltip':       'Fork Here (Alt+B to pick bar)',
    ...
    'topbar.openedDataFolder':      'Opened market_data folder (may be behind this window)',
    'topbar.reloadData':            'Reload Data',
    'topbar.reloadDataTooltip':     'Reload data (after adding / editing files)',
    'topbar.gotoLatest':            'Latest',
    'topbar.gotoLatestTooltip':     'Back to latest bar (end history browse)',
    'topbar.indicators':            'Indicators',
    'topbar.indicatorsTooltip':     'Add / manage indicators',
    'topbar.eventLog':              'Event Log',
    'topbar.eventLogTooltip':       'Structural event log — BOS / CHoCh / Zone state during replay',
    'topbar.multiPane':             'Multi-TF',
    'topbar.multiPaneTooltip':      'Multi-timeframe view — show several timeframes at once',
    'panes.layoutLabel':            'Layout:',
    'panes.layoutCols3':            'Three columns',
    'panes.layoutMainstack':        'Main + sidebar',
    'panes.layoutQuad':             '2×2 grid',
    'panes.addPane':                '+ Add pane',
    'panes.removePaneTooltip':      'Remove pane',
    'panes.emptySlot':              '+ Add a timeframe pane',
    'panes.currentTfTooltip':       'Enter timeframe',
    'panes.manageTfTooltip':        'Manage saved frequencies',
    'panes.manageTfTitle':          'Saved frequencies',
    'panes.tfGroupMinutes':         'Minutes',
    'panes.tfGroupHours':           'Hours',
    'panes.tfGroupDaysUp':          'Day and up',
    'eventLog.title':               'Structural Event Log',
    'eventLog.empty':               '(No events yet — enter replay mode and step forward to see BOS / CHoCh / Zone changes)',
    'eventLog.clearTooltip':        'Clear log',
    'eventLog.filterBos':           'BOS',
    'eventLog.filterChoch':         'CHoCh',
    'eventLog.filterZone':          'Zone',
    ...
    // panel.indicators.* — indicator-manager-spec strings (en)
    'panel.indicators.libraryTitle':     'Indicators',
    'panel.indicators.searchPlaceholder':'Search indicators…',
    'panel.indicators.settingsTitle':    'Indicator Settings',
    'panel.indicators.legendShow':       'Show',
    'panel.indicators.legendHide':       'Hide',
    'panel.indicators.legendSettings':   'Settings',
    'panel.indicators.legendRemove':     'Remove indicator',
    'panel.indicators.legendCollapse':   'Collapse list',
    'panel.indicators.legendExpand':     'Expand list',
    'panel.indicators.empty':            'No indicators registered',
    'panel.indicators.noMatch':          'No matching indicators',
    ...
    'tool.rectangleTooltip':        'Rectangle (Alt+R or Alt+G)',
    'tool.path':                    'Path',
    ...
    'replay.randomBar':             'Random bar',
    'replay.menuItemLatest':        'Latest bar',
    'replay.randomBarTooltip':      'Random start (jump to a random bar)',
    'replay.statusRandom':          'Jumped to a random start',
    'replay.startMenuTitle':        'Select start point',
    'replay.menuItemBar':           'Bar',
    'replay.menuItemDate':          'Date…',
    'replay.menuItemEarliest':      'First available date',
    'replay.pickRandom':            'Select random bar',
    'replay.pickDate':              'Select date',
    'replay.pickEarliest':          'First available date',
    'replay.datePickTitle':         'Select date',
    'replay.dateFirstAvail':        'Select first available date',
    'replay.dateCancel':            'Cancel',
    'replay.dateConfirm':           'Select',
    ...
    'sim.exitLevels':               'Exit Levels',
    'sim.exitAddTp':                '+ TP',
    'sim.exitAddSl':                '+ SL',
    'sim.exitCoverage':             'TP covers {pct}%',
    'sim.exitRunner':               '· {qty} runner',
    'sim.exitOver':                 '· {qty} over (clamped to size)',
    'sim.exitRemove':               'Remove level',
    'sim.exitEmpty':                'No exit levels yet — drag +TP/+SL or add below',
    'sim.beAdjLabel':               'BE',
    'sim.qtyStepTitle':             'Increment per step (remembered)',
    ...
    'panel.drawing.textWrap':       'Word wrap',
    ...
    'panel.drawing.arrow':          'Arrow',
    'panel.drawing.arrowLeft':      'Left-end arrow',
    'panel.drawing.arrowRight':     'Right-end arrow',
    'panel.drawing.extend':         'Extend',
    'panel.drawing.extendLeft':     'Extend left',
    'panel.drawing.extendRight':    'Extend right',
    ...
    'panel.drawing.tplBtn':         'Template ▾',
    'panel.drawing.tplSaveAs':      'Save as...',
    'panel.drawing.tplNamePh':      'Template name',
    'panel.drawing.opacity':        'Opacity',
    ...
    'panel.fibo.titleTime':         'Trend-Based Fib Time',
    ...
    'panel.position.toolShowTradeLink': 'Show entry-exit connector line',
    'panel.position.toolLinkWinColor': 'Profit line color',
    'panel.position.toolLinkLossColor': 'Loss line color',
    ...
    'history.splitExits':           '{n} exits',
    'history.exitDetailTitle':      'Scaled exits',
    ...
    'dlg.rrPopupTitleTarget':       'Set Target from Stop',
    'dlg.rrPopupTitleStop':         'Set Stop from Target',
    'dlg.rrHint':                   'Risk/reward ratio (> 0)',
    'dlg.rrTargetLabel':            'Target',
    'dlg.rrStopLabel':              'Stop',
    'dlg.tfMonth':                  'Month',
    'dlg.tfHour':                   'Hour',
    'dlg.tfDay':                    'Day',
    'dlg.tfWeek':                   'Week',
    ...
    'ctx.setTargetRR':              'Set Target from Stop…',
    'ctx.setStopRR':                'Set Stop from Target…',
